...
parser.add_argument("-f", "--file",type=str,\
        ...
        dest="fileList", action="append")  # Definimos un ARGUMENTO del tipo OPCIONAL. Del tipo STRING. 
        # Metavar es el alias. 
        # Dest es el nombre de la VARIABLE. 
        # Action es el comando a realizar, en este caso APPEND. Añade al final.
parser.add_argument("-v", "--verbose",action="store_true",default=False) # Definimos un ARGUMENTO del tipo OPCIONAL de -v --verbose, que tendrá como acción, almacenar TRUE, por defecto es FALSO.
# Si encuentra la "v", almacena true. 
args=parser.parse_args() # Pulsamos el botón de ARGPARSE.
